...
3. In the final round, there will some programs, those assign to you and you have solve this program in minimum time.Whose time is minimum, he/she will winner of league of coders.</p><br><p>
			 <hr>            <br>
			 <input type="hidden" value="5" name="event_name" />
			 <input type="submit" value="Select" class="btn btn-primary" />
			</section>
       
            <ul class="pagination">
                <li><a href="#">&laquo;</a></li>
                <li><a href="Computer.php">1</a></li>
                <li><a href="c1.php">2</a></li>
                <li  class="active"><a href="c2.php">3</a></li>
        ...
        <div class="col-sm-4 sidebar">
            ...
            <section>
                ...
                <div class="list-group tpad">
                    ...
                    <a href="Civil.php" class="list-group-item"><span class="badge">7</span>Civil Engineering</a>
                    <a href="Mechanical.php" class="list-group-item"><span class="badge">5</span>Mechanical Engineering</a>
                    <a href="Production.php" class="list-group-item"><span class="badge">27</span>Production Engineering</a>
