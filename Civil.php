...
<div class="container padded">
    <div class="row">
        <div class="col-sm-8 blog">
            <section><div>
                <h1>Civil &raquo; Events</h1><hr>
                <p class="lead">Survey Hunt</a></p>
                <hr>
                <p><span class="glyphicon glyphicon-time"></span> Posted on Oct 26, 2018 at 9:00 PM</p>
                <hr>
                <img src="images/ci.jpg" class="img-responsive">
                <hr>
                <p>If you are good in surveying then this event is best for you.</p><br><p>By participating in this event you can know more about surveying.There are 3 rounds in this event.</p><br><p>1. In the first round there will be a paper test. In this there will time limit, for test, is 1 hour. If you will select for next round then you will get message or email from us.
...
3. In the final round, there will some situation, those assign to you and you have to solve this situation through instrument.Whose is best, he/she will winner of Survey Hunt.</p><br><p>
			 <hr>            <br>
			 <input type="hidden" value="6" name="event_name" />
        ...
        <div class="col-sm-4 sidebar">
            ...
            <section>
                ...
                <div class="list-group tpad">
                    ...
                    <a href="Civil.php" class="list-group-item active"><span class="badge">2</span>Civil Engineering</a>
