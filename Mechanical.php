...
<div class="container padded">
    <div class="row">
        <div class="col-sm-8 blog">
            <section><div>
                <h1>Mechanical &raquo; Events</h1><hr>
                <p class="lead">Optimus Prime</a></p>
                <hr>
                <p><span class="glyphicon glyphicon-time"></span> Posted on Oct 23, 2018 at 11:00 AM</p>
                <hr>
                <img src="images/m.jpg" class="img-responsive">
                <hr>
                <p>If you are good in making some models then this event is best for you.</p><br><p>By participating in this event you can know more about mechanical stuffs.There are 2 rounds in this event.</p><br><p>1. In the first round there will,you have to make model from candy stick. In this there will time limit, for test, is 1 hour. If you will select for next round then you will get message or email from us.
</p><br><p>
2. In the final round, there will some fight between two models, those you have created.Whose moodel is best, he/she will winner of Optimus Prime.</p><br><p>
			 <hr>            <br>
			 <input type="hidden" value="8" name="event_name" />
            ...
            <section>
                <h3 class="tpad">Events</h3>
                 <div class="list-group tpad">
                    ...
                    <a href="Mechanical.php" class="list-group-item active"><span class="badge">1</span>Mechanical Engineering</a>
