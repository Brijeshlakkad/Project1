...
<div class="container padded">
    <div class="row">
        <div class="col-sm-8 blog">
            <section><div>
                <h1>Non-tech &raquo; Events</h1><hr>
                <p class="lead">Ingenius</a></p>
                <hr>
                <p><span class="glyphicon glyphicon-time"></span> Posted on Oct 29, 2018 at 10:00 AM</p>
                <hr>
                <img src="images/movie.jpg" class="img-responsive">
                <hr>
				<p>In this event,you have to make short film.and obiviously,whose short film is best,he/she is the winner of Ingenius.</p>
			 <hr>            <br>
			 <input type="hidden" value="13" name="event_name" />
			 <input type="submit" value="Select" class="btn btn-primary" />
			</section>
       
            <ul class="pagination">
                <li><a href="#">&laquo;</a></li>
                <li><a href="Nontech.php">1</a></li>
                <li class="active"><a href="n1.php">2</a></li>
            ...
            <section>
                <h3 class="tpad">Events</h3>
                 <div class="list-group tpad">
					...
					<a href="Nontech.php" class="list-group-item active"><span class="badge">2</span>Non-Tech Events</a>
                </div>
                <hr>
            </section>
              <section>
