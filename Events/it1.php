    ...
    <div class="row">
        <div class="col-sm-8 blog">
            <section><div>
                ...
                <p class="lead">Javaneans</a></p>
                <hr>
                <p><span class="glyphicon glyphicon-time"></span> Posted on Oct 28, 2018 at 12:10 AM</p>
                <hr>
                <img src="images/java.jpeg" style="width:1800px;height:500px" class="img-responsive">
                <hr>
                <p>If you are good in java coding then this event is best for you.</p><br><p>By participating in this event you can know more about java language.There are 2 rounds in this event.</p><br><p>1. In the first round there will be a quiz about java and its basic. In this there will time limit in quiz. If you will select for next round then you will get message or email from us.
</p><br><p>
2. In the final round, there will some application programs, those assign to you and you have create your assigned application in minimum time.Whose application is best,he/she will winner of Javaneans.</p><br><p>
			 <hr>            <br>
			 <input type="hidden" value="1" name="event_name" />
			 <input type="submit" value="Select" class="btn btn-primary" />
			</section>
       
            <ul class="pagination">
                <li><a href="#">&laquo;</a></li>
                <li><a href="All_event.php">1</a></li>
                <li class="active"><a href="it1.php" >2</a></li>
