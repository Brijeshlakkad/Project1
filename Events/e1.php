    ...
    <div class="row">
        <div class="col-sm-8 blog">
            <section><div>
                ...
                <p class="lead">Robotics Competition</a></p>
                <hr>
                <p><span class="glyphicon glyphicon-time"></span> Posted on Oct 26, 2018 at 11:00 AM</p>
                <hr>
                <img src="images/robot.jpg" class="img-responsive">
                <hr>
                <p>There are 2 rounds in this event.</p><br><p>1. In the first round there will be a soccer round for robot. In this there will time limit, for competition. If you will select for next round then you will get message or email from us.
</p><br><p>
2. In the final round, there will fight between two robots.Whose robot is winner, he/she will winner of Robot Competition.</p><br><p>
			 <hr>            <br>
			 <input type="hidden" value="11" name="event_name" />
			 <input type="submit" value="Select" class="btn btn-primary" />
			</section>
       
            <ul class="pagination">
                <li><a href="#">&laquo;</a></li>
                <li><a href="Electrical.php">1</a></li>
                <li class="active"><a href="e1.php">2</a></li>
