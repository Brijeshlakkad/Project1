...
<div class="container padded">
    <div class="row">
        <div class="col-sm-8 blog">
            <section><div>
                <h1>Electrical/Electronics &raquo; Events</h1><hr>
                <p class="lead">Electro Brokers</a></p>
                <hr>
                <p><span class="glyphicon glyphicon-time"></span> Posted on Oct 25, 2018 at 10:00 AM</p>
                <hr>
                <img src="images/electro.jpg" class="img-responsive">
                <hr>
                <p>If you are good in fundamental of electronics then this event is best for you.</p><br><p>By participating in this event you can know more about electronics.There are 3 rounds in this event.</p><br><p>1. In the first round there will be a paper test. In this there will time limit, for test, is 1 hour. If you will select for next round then you will get message or email from us.
...
3. In the final round, there will some circuit, those assigned to you and you have to solve this circuit in minimum time.Whose time is minimum, he/she will winner of Electro Brokers.</p><br><p>
			 <hr>            <br>
			 <input type="hidden" value="10" name="event_name" />
            ...
            <section>
                <h3 class="tpad">Events</h3>
                 <div class="list-group tpad">
					...
					<a href="Electrical.php" class="list-group-item active"><span class="badge">2</span>Electrical/Electronics Engineering</a>
