    ...
    <div class="row">
        <div class="col-sm-8 blog">
            <section><div>
                ...
                <p class="lead">Soil Bridge</a></p>
                <hr>
                <p><span class="glyphicon glyphicon-time"></span> Posted on Oct 26, 2018 at 10:00 PM</p>
                <hr>
                <img src="images/ci1.jpg" class="img-responsive">
                <hr>
                </p><br><p>There is only one round.In this round, you have to make small bridge that should be in good condition.<br>Whose bridge is best, he/she will winner of Soil Bridge.</p><br><p>
			 <hr>            <br>
			 <input type="hidden" value="7" name="event_name" />
            ...
            <ul class="pagination">
                ...
                <li><a href="#">1</a></li>
                <li class="active"><a href="c1.php">2</a></li>
