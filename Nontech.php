    ...
    <div class="row">
        <div class="col-sm-8 blog">
            <section><div>
                ...
                <p class="lead">Cricket</a></p>
                <hr>
                <p><span class="glyphicon glyphicon-time"></span> Posted on Oct 28, 2018 at 11:00 AM</p>
                <hr>
                <img src="images/n.jpg" class="img-responsive">
                <hr>
                <p>If you are very good in cricket game then this event is best for you.</p><br>
				<p>This event is for fun and entertainment.</p>
			 <hr>            <br>
			 <input type="hidden" value="12" name="event_name" />
